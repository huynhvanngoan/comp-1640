            ...
            <PieChart>
                <Pie
                    ...
                    label={({
                        ...
                        if (percent > 5) { // Chỉ hiển thị label cho các phần trăm lớn hơn 5%
                            return `${name} ${(percent * 100).toFixed(2)}%`; // Hiển thị 2 chữ số thập phân
                        } else if (percent > 0) {
                            return null; // Gộp các phần trăm nhỏ lại thành một phần trăm tổng hợp
                        }
