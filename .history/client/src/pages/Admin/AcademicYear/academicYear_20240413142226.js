                    ...
                    >
                        ...
                        >
                            <DatePicker
                                ...
                                disabledDate={(current) => {
                                    // Nếu là ngày hiện tại, không cho phép chọn
                                    return current && current.isSame(moment(form2.getFieldValue('closureDate')), 'day');
                                }}
                        ...
                        >
                            <DatePicker
                                ...
                                disabledDate={(current) => {
                                    // Nếu là ngày hiện tại, không cho phép chọn
                                    return current && current.isSame(moment(form2.getFieldValue('finalClosureDate')), 'day');
                                }}
                            />
                        </Form.Item>
                    </Form>
