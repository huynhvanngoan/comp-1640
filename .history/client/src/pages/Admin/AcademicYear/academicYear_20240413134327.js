...
const AcademicYear = () => {
    ...
    const handleOkUser = async (values) => {
        ...
        try {
            ...
            const closureDate1 = moment(values.closureDate); // Chuyển đổi closureDate thành đối tượng moment
            const finalClosureDate1 = moment(values.finalClosureDate); // Chuyển đổi finalClosureDate thành đối tượng moment

            // Kiểm tra ngày finalClosureDate phải sau closureDate
            if (finalClosureDate1.isBefore(closureDate1)) {
                notification.error({
