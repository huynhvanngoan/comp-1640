...
const AssetCategory = () => {
    ...
    const handleUpdateAcademic = async (values) => {
        ...
        try {
            ...
            return assetCategoryApi.updateAcademy(academic, id).then((response) => {
                if (response === undefined) {
                    notification["error"]({
                        message: `Notification`,
    ...
    const handleAcademicList = async () => {
        try {
            await assetCategoryApi.listAcademic().then((res) => {
    ...
    const handleDeleteAcademic = async (id) => {
        setLoading(true);
        try {
            await assetCategoryApi.deleteAcademic(id).then((response) => {
                if (
                    response.message ===
