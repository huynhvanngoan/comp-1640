...
import academicYearApi from "../../../apis/assetCategoryApi";
const AcademicYear = () => {
    ...
    const handleOkUser = async (values) => {
        ...
        try {
            ...
            if (
                values.finalClosureDate &&
                moment(values.finalClosureDate).isAfter(values.closureDate)
            ) {
    ...
    const handleUpdateAcademic = async (values) => {
        ...
        try {
            ...
            return academicYearApi.updateAcademy(academic, id).then((response) => {
                if (response === undefined) {
                    notification["error"]({
                        message: `Notification`,
    ...
    const handleAcademicList = async () => {
        try {
            await academicYearApi.listAcademic().then((res) => {
    ...
    const handleDeleteAcademic = async (id) => {
        setLoading(true);
        try {
            await academicYearApi.deleteAcademic(id).then((response) => {
                if (
                    response.message ===
    ...
    const handleFilter = async (name) => {
        try {
            const res = await academicYearApi.searchAssetCategory(name);
            setCategory(res.data);
        } catch (error) {
