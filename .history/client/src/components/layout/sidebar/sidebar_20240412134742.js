...
return (
<Sider width={isSidebarCollapsed ? 80 : 230} style={{
                position: "fixed",
                top: 60,
  ...
  <Menu mode="inline" selectedKeys={location.pathname.split("/")} defaultOpenKeys={["account"]} style={{
                    height: "100%",
                    borderRight: 0,
    ...
    <Menu.Item onClick={()=> navigate(map.link, map.key)}
      key={map.key}
      icon={map.icon}
